...
const page = (mark, txt) => `<style>html,body{margin:0;background:transparent}
 .l{display:inline-block;text-align:center;padding:0}
 .l svg{display:block;width:300px;height:320px;margin:0 auto 64px}
 .n{display:block;white-space:nowrap;font-family:'Avenir Next';font-weight:200;font-size:64px;letter-spacing:14.6px;text-indent:14.6px;color:${txt}}</style>
...
(async () => {
  ...
  await p.setViewport({width:1400,height:600,deviceScaleFactor:3});
