...
(async () => {
  ...
  await p.goto("file:///Users/halawa/code/Elkhamees-/concepts/rebrand-2026/brandbook-en.html",{waitUntil:"networkidle0"});
  await p.evaluateHandle("document.fonts.ready");
  await p.pdf({path:"AlKhamees-Brand-Identity-EN.pdf", width:"297mm", height:"210mm", printBackground:true, preferCSSPageSize:true});
