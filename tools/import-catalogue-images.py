...
MAP = [
    ...
    # ⚠️ لا صورة موديل للقلادة العريضة. الصورة المولّدة (4model-ai.png) سُحبت
    # من الكتالوج في 2026-08-03: القطعة التي وضعها المولّد على الرقبة هي
    # تصميم الإسورة «غصن» لا هذه القلادة. لا تُعاد إلا بتصوير حقيقي.
