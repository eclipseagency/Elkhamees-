...
/* ⚠️ الرئيسية صارت واجهة عرض لا صفحة نصّ (قرارا مصطفى 2026-08-03):
   **من نحن** و**الخدمات** وبنودها (الاستبدال والشحن) و**الأسئلة الشائعة**
   كلها رُفعت من هنا. كانت تُطبع بالكامل على الرئيسية فتُقرأ الصفحة نصاً
