...
MAP = [
    ...
    # ⚠️ occ-wedding.jpg **لا تُولّد من هنا بعد الآن** (2026-08-03). الأصل
    # 333.jpeg فستان سهرة مكشوف الكتفين بفتحة صدر، وطلب مصطفى أن يكون
    # الفستان مقفولاً. الملف الحالي نسخة معدّلة بالذكاء الاصطناعي من نفس
    # الصورة: رقبة مقفولة بنفس القماش والقلادة والإضاءة كما هي
    # (Higgsfield · nano_banana_pro). إعادة تشغيل هذا السطر تُرجع الصورة
    # المكشوفة فوقها، فبقي معطّلاً عمداً. التفاصيل في assets/sources/README.md.
    # ('333.jpeg', os.path.join(OUT, 'occ-wedding.jpg'),  1100, 1375),
